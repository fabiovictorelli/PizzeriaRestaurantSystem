...
//||||||||||||||||||||||||||||||||||||exibindo select||||||||||||||||||||||||||||||||||||||||
             echo "<center>";      
		        echo "<font size=\"3\"><b>Ocultando Selecionado</b></font>";
		...
		echo "<table border=\"0\" align=\"center\"  cellspacing=\"0\" 
             ...
             echo "<tr ";
	            ...
	            echo ">
		            ...
		            border-color : $cor_borda;color:$texto\">".$modelo[$i]."</td>
				    <td style=\"border-style : $estilo;border-width : $borda_celula;
		            border-color : $cor_borda;color:$texto\">".$cor[$i]."</td>
				    <td style=\"border-style : $estilo;border-width : $borda_celula;
